...
public class ComponentBank extends ComponentVillage
{
    ...
    public static ComponentBank buildComponent (ComponentVillageStartPiece villagePiece, @SuppressWarnings("rawtypes") List pieces, Random random, int p1, int p2, int p3, int p4, int p5)
    {
    ...
    public boolean addComponentParts (World world, Random random, StructureBoundingBox sbb)
    {
        ...
        this.fillWithBlocks(world, sbb, 0, 0, 0, 6, 0, 6, Block.stone.blockID, Block.stone.blockID, false); //Base
        ...
        this.placeDoorAtCurrentPosition(world, sbb, random, 3, 1, 0, this.getMetadataWithOffset(Block.doorIron.blockID, 1));
        ...
        this.placeBlockAtCurrentPosition(world, EVBlocks.enderCoinBank.blockID, i, 5, 1, 5, sbb);
